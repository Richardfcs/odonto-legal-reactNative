      ...
      <FlatList
        ...
        ListHeaderComponent={() => (
            <View style={styles.buttonContainer}>
                ...
                <Button icon="file-document-outline" mode="outlined" disabled={selectedIds.length === 0} onPress={() => Alert.alert("Gerar Laudo", `IDs selecionados: ${selectedIds.join(', ')}`)}>Gerar Laudo</Button>
            </View>
        )}
