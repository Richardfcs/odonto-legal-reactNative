...
import ToothEditModal from '../components/ToothEditModal';
...
const styles = StyleSheet.create({
    ...
    title: { textAlign: 'center', marginVertical: 16, fontSize: 22, fontWeight: 'bold' },
    infoText: { textAlign: 'center', marginVertical: 10, color: 'gray' },
    ...
    saveButton: { margin: 16, paddingVertical: 6 },
});
